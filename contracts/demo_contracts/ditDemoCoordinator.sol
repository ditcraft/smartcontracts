...
contract ditDemoCoordinator {
    ...
    function proposeCommit(bytes32 _repository, bytes32 _commitHash, string calldata _topic, uint256 _knowledgeID, uint256 _numberOfKNW, uint256 _voteDuration, uint256 _amountOfTokens) external onlyPassedKYC(msg.sender) returns (uint256 proposalID) {

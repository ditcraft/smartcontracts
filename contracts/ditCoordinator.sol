...
contract ditCoordinator {
     ...
     */
    function initRepository(bytes32 _repository, string _label1, string _label2, string _label3, uint256[7] _voteSettings) external onlyPassedKYC(msg.sender) returns (bool){
